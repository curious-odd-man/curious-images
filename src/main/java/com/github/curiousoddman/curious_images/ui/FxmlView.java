...
import com.github.curiousoddman.curious_images.ui.controller.screen.TriageController;
...
public record FxmlView<T>(String fxmlPath, Class<T> controllerClass) {
    ...
    public static final FxmlView<TriageController>               TRIAGE                  = new FxmlView<>("/fxml/triage.fxml", TriageController.class);
    ...
    public static final FxmlView<GridCellController>             PHOTO_CELL              = new FxmlView<>("/fxml/photo_cell.fxml", GridCellController.class);
    ...
    public static final FxmlView<GridController>                 PHOTO_GRID              = new FxmlView<>("/fxml/photo_grid.fxml", GridController.class);
    ...
    public static final FxmlView<ImportStatsController>          IMPORT_STATS            = new FxmlView<>("/fxml/import_stats.fxml", ImportStatsController.class);
}
